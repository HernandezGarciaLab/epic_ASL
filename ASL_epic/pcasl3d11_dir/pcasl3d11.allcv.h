...
#ifndef h_pcasl3d11_allcv_h
#define h_pcasl3d11_allcv_h
...
int psdtottime = 0;     /* actual TR = psdseqtime*opslquant */
...
float 	B1tag_distance = 0;   /*distance between center of slab and tagging plane*/
...
int 	tmin_rfrepeat = 0;
int 	nreps = 0;  /* number of times the RF labeling pulses need to be played */
...
float 	pcasl_Gmax = 0.6; /* default gradient max aplitude in pcasl pulse train */
/* double 	pcasl_Gave = 0.03;*/ /* default average gradient momoent */
float 	pcasl_Gave = 0.06; /* lhg 4/12/18 default average gradient momoent */
...
float 	myPhaseCorr = 0;
int 	doRT=0;
int 	ia_gzrftag1r_0 = 0;   /* initial value for refocuser's amplitude in pCASL pulses - LHG 6/30/09 */
