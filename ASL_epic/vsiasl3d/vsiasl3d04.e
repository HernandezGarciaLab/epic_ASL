...
/* end changes for DV26 */
abstract("vel. sel. inversion ASL  with 3D Spiral acquisition with GRAPPAZ");
psdname("vsiasl3d03");
...
int cveval()
{
	...
	cvdesc(opuser26,"VSI control image type (1) flip the magnitude  (2) no RF  (3) flip phase (4) flip grads (5) no VelSel grads (6) monopolar");
	cvmin(opuser26,0);
	cvmax(opuser26, 10);
	cvdef(opuser26,6);
	opuser26 = 6;
	...
	t_adjust = RUP_GRD(optr - psdseqtime*opslquant - t_tag - t_delay - t_preBS);                 /* LHG 7.18.18 */
